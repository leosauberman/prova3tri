...
class BreedsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create breed" do
    assert_difference('Breed.count') do
      post breeds_url, params: { breed: { caracteristicas: @breed.caracteristicas, pesoM: @breed.pesoM, porte: @breed.porte, raca: @breed.raca } }
    end
  ...
  test "should update breed" do
    patch breed_url(@breed), params: { breed: { caracteristicas: @breed.caracteristicas, pesoM: @breed.pesoM, porte: @breed.porte, raca: @breed.raca } }
